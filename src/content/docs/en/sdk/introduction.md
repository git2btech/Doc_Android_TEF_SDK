...
Thanks to this characteristic, within the entirety of the library's classes, only one is exposed to the developer: [consumer](/Doc_Android_TEF_SDK/en/sdk/classes/consumer).
